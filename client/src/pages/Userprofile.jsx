...
import { getDateToday } from '../services/mainservice';
  ...
  return (
    <div className='flex justify-start items-center dashboard-body-background'>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className='text-xl text-black font-bold mt-5'>{localStorage.getItem('username')}</h1>
        </div>
        <div className='mt-10 w-full flex flex-col justify-start'>
          ...
          <h1 className='hover:bg-gray-400 hover:text-gray-800 flex flex-row text-lg px-10 py-2 text-gray-600 cursor-pointer'><Send size={24} color='black' className='mr-4'/>Create Recipe</h1>
      ...
      <div className='flex justify-start items-start flex-col h-screen w-11/12 gap-12'>
        ...
        <div className='ml-4 w-11/12 h-5/6 grid grid-cols-3 grid-rows-2 gap-4'>
          ...
          <div className='col-start-2 col-span-1 row-start-1 row-span-1 bg-red-400 rounded-md dashboard-card-background text-gray-600 font-light text-xl pt-2 pl-2 shadow-xl scale-animation cursor-pointer'>Main Courses</div>
          <div className='col-start-3 col-span-1 row-start-1 row-span-1 bg-red-400 rounded-md dashboard-card-background text-gray-600 font-light text-xl pt-2 pl-2 shadow-xl scale-animation cursor-pointer'>Side Dishes</div>
          <div className='col-start-1 col-span-1 row-start-2 row-span-1 bg-red-400 rounded-md dashboard-card-background text-gray-600 font-light text-xl pt-2 pl-2 shadow-xl scale-animation cursor-pointer'>Desserts</div>
          <div className='col-start-2 col-span-1 row-start-2 row-span-1 bg-red-400 rounded-md dashboard-card-background text-gray-600 font-light text-xl pt-2 pl-2 shadow-xl scale-animation cursor-pointer'>Beverages</div>
          <div className='col-start-3 col-span-1 row-start-2 row-span-1 bg-red-400 rounded-md dashboard-card-background text-gray-600 font-light text-xl pt-2 pl-2 shadow-xl scale-animation cursor-pointer'>Snacks</div>
        </div>
      </div>
    </div>
  );
