  ...
  return (
    <div className='pt-4 pr-4 pl-4 h-screen w-full overflow-y-auto dashboard-main-background'>
      <div className='grid grid-cols-10 grid-rows-10 gap-4'>
        <div className='col-start-1 col-span-6 row-start-1 row-span-2 text-2xl pt-3 pl-3 rounded-xl'>
          Welcome Back <span className='text-gray-600 font-bold'>{username}</span>!
          <h1 className='text-lg mt-2'>{today}</h1>
        </div>
        <div className='col-start-1 col-span-3 dashboard-second-background row-start-3 row-span-2 rounded-lg shadow-md'>
        ...
        <div className='col-start-7 col-span-4 dashboard-second-background row-start-5 row-span-3 rounded-lg shadow-md'>
          <h1 className='mt-4 ml-4 font-bold text-xl'>Recently Published</h1>
          <h1>(Recipe Title)</h1>
          <h1>(Date Created)</h1>
        </div>
        <div className='col-start-7 col-span-4 dashboard-second-background row-start-8 row-span-3 rounded-lg shadow-md'>
        </div>
        <div className='col-start-1 col-span-6 row-start-5 row-span-6 dashboard-second-background rounded-lg shadow-md'>
